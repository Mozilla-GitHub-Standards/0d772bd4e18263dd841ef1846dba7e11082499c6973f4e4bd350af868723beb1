...
// Hrmph - but for markh, reload doesn't work - hence the 'true ||'...
if (true || !navigator.apps.services.contacts) {
    navigator.apps.services.contacts = (function() {
        ...
        var ContactServerOrigin = "http://localhost:8301";
        ...
        function callGet(args) {
            ...
            chan.call({
                method: "get",
                params: {
                    thisPermission: 'contacts.get',
                    allPermissions: args['allPermissions'] // may be undefined.
                },
                error: function(error, message) {
